...
module.exports = React.createClass({
  ...
  drag(e) {
    ...
    if (!this.onPreChange(tree.getNodeByTop(index.top))) {
	return;
    }
  ...
  dragEnd() {
    ...
    //if (this.onPreChange(this.state.tree)) {
  ...
  onPreChange(treeNode) {
      if(this.props.onPreChange) return this.props.onPreChange(treeNode.node);
      return true;
  },
